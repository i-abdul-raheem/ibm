...
export default function ViewAccount(props) {
  ...
  const [updateAccount, showUpdateAccount] = useState(false);
  return (
    <>
      <Modal
        show={props.show}
        ...
        <Modal.Body>
          <Row>
            <Col lg={4} md={4} sm={12}>
                ...
                <Card.Body>
                  <Row>
                    ...
                    <Col xs={8} className="mb-3">
                      ...
                      <Button className="me-1" onClick={() => showUpdateAccount(true)}>Update</Button>
              ...
              <Card className="mb-3">
                <Card.Body>
                  <Card.Title>Account Information</Card.Title><hr/>
